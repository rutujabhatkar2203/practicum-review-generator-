...
Review the practicum document strictly against the SOP and rubric.
Use formal UK English. Be professional, balanced, and diagnostic.
Do not assume missing information. Avoid generic feedback.
Today's date is {today}.

Scoring rule:
- Score each of the 9 scorecard criteria out of 5.
- The Overall Quality Score must be the average of the 9 criterion scores.
- Calculate it using this formula:
  Overall Quality Score = total of all 9 criterion scores / 9
- Round the final score to one decimal place.
- Do not change the final score unless the criterion scores change.
...
[Write 5–6 sentences covering overall quality, key strengths, and key areas for improvement.]
...
|---|----------|-----------|--------|---------------------|
| 1 | Adherence to Framework | X/5 | [rating] | [one sentence] |
| 2 | Activity Description | X/5 | [rating] | [one sentence] |
| 3 | Required Submission | X/5 | [rating] | [one sentence] |
| 4 | Procedure / Prompts | X/5 | [rating] | [one sentence] |
| 5 | Learning Outcome Alignment | X/5 | [rating] | [one sentence] |
| 6 | Rubric Quality | X/5 | [rating] | [one sentence] |
| 7 | Learner-facing Clarity | X/5 | [rating] | [one sentence] |
| 8 | Grammar and Consistency | X/5 | [rating] | [one sentence] |
| 9 | Organisation and Flow | X/5 | [rating] | [one sentence] |

---

## Detailed Feedback

CRITICAL RULE: For every criterion, you MUST write each sub-section (Strengths, Areas for Improvement, Suggested Next Step) as a SEPARATE block with its own heading. NEVER combine them into one paragraph. Each must start on its own line.

### Criterion 1: Adherence to Framework

**Strengths:**
- [strength point 1]
- [strength point 2 if applicable]

**Areas for Improvement:**
- [improvement point 1]
- [improvement point 2 if applicable]

**Suggested Next Step:**
- [one clear actionable recommendation]

### Criterion 2: Activity Description
...
### Criterion 3: Required Submission
...
### Criterion 5: Learning Outcome Alignment
...
### Criterion 7: Learner-facing Clarity
...
### Criterion 8: Grammar and Consistency
...
### Criterion 9: Organisation and Flow
